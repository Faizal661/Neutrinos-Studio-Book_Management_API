...
export class findBooksById {
  ...
  private constructor(
    ...
    this.serviceName = 'findBooksById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findBooksById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findBooksById');
    //appendnew_flow_findBooksById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findBooksById');

    this.app['post'](
      `${this.serviceBasePath}/dm/books/books/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findBooksById_HttpIn
  }
  //   service flows_findBooksById

  //appendnew_flow_findBooksById_start
  ...
  //appendnew_flow_findBooksById_Catch
}
